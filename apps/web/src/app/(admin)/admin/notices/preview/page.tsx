...
const sampleOffer = {
  ...
  deadline: '2026年4月15日',
  cancelReasons: [
    '入社日までに健康上の理由により勤務が困難と認められた場合',
    '経歴・学歴等に虚偽の申告があった場合',
    '反社会的勢力との関係が判明した場合',
    'その他、採用内定時に予測しえなかった事由により、採用が不適当と認められた場合',
  ],
  requiredDocs:
...
const sampleLabor = {
  date: '2026年4月3日',
  person: '長谷川 翼',
  contractTerm: '期間の定めあり',
  contractRange: '2026年5月1日 ～ 2026年10月31日',
  workplace: '当社が指定する場所',
  ...
  breakTime: '60分',
  overtime: '有',
  holidays: '定例日；毎週土曜日、日曜日、国民の祝日、その他（シフト表に準ずる）',
